##Line Source 1: Algorithm for 1st dataset, column 'D'
##Randomises number of datapoints

import math
import numpy as np 

file = np.genfromtxt("dose1d_1.csv",delimiter = ',')
x=file[:,0]
y=file[:,1]
z=file[:,2]
dosage = file[:,3]
...
print("Original source is at x = 0.1 and y = 0")
...
np.savetxt("newdata1.csv",data,delimiter=',')